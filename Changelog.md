...
- Remove route names from `app/employee_routes` (@beardedtim)
...
- **Add progress bar while loading code splitted employee_routes**, thanks to @KarandikarMihir
...
- **Scaffolding**: Thanks to @somus, you can now run `npm run generate` in your
  terminal and immediately create new components, containers, sagas, employee_routes and
